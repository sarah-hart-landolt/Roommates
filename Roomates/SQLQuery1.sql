...
SELECT roommate.Id, roommate.FirstName, roommate.LastName, roommate.RentPortion, roommate.MoveInDate, roommate.roomId, room.Id, room.Name, room.MaxOccupancy FROM Roommate roommate JOIN Room room ON room.Id = roommate.roomId